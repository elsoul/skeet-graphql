...
export type VertexChatMenu_query$data = {
  readonly vertexChatRoomConnection: {
...
export type VertexChatMenu_query$key = {
  readonly " $data"?: VertexChatMenu_query$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./VertexChatMenuPaginationQuery.graphql')
    }
  },
  "name": "VertexChatMenu_query",
  "selections": [
    {
      "alias": "vertexChatRoomConnection",
      "args": null,
      "concreteType": "QueryVertexChatRoomConnection_Connection",
      "kind": "LinkedField",
      "name": "__VertexChatMenu_vertexChatRoomConnection_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
