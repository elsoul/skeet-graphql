import { VertexChatScreenQuery$variables } from '@/__generated__/VertexChatScreenQuery.graphql'
...
export default function RefetchVertexChat({ refetch }: Props) {
